...
png("report/2021_BrS_FO_SAG_Current_demersal.png",
    width = 131.32,
    height = 88.9,
    units = "mm",
    res = 300)
...
#check this file name
png("report/2021_BrS_FO_SAG_Current_pelagic.png",
    width = 131.32,
    height = 88.9,
    units = "mm",
    res = 300)
...
#check this file name
png("report/2021_BrS_FO_SAG_Current_crustacean.png",
    width = 131.32,
    height = 88.9,
    units = "mm",
    res = 300)
...
#check this file name
png("report/2021_BrS_FO_SAG_Current_All.png",
    width = 131.32,
    height = 88.9,
    units = "mm",
    res = 300)
...
#no discards in 2019
discardsA <- plot_discard_trends(catch_trends2, 2019, cap_year, cap_month )
